...
"No writes" means the server. The one script these pages carry reads and writes
a theme preference in `localStorage`, on the reader's own machine — it sends
nothing, and there is no route it could send it to.
